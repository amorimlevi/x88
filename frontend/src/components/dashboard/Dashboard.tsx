            ...
            {activeSection === 'dashboard' && (
              ...
              <div className="card">
                ...
                <div 
                  ...
                  className="flex items-baseline justify-between py-3 px-4 list-item relative overflow-hidden cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors"
                >
